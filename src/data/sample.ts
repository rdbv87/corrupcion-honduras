...
export const sampleEventos: EventoTemporal[] = [
  {
    ...
    descripcion: 'La MACC inicia investigación sobre redes de corrupción en contrataciones públicas',
  ...
  },
  {
    id: '2',
    caso_id: '1',
    titulo: 'Denuncia ante Ministerio Público',
    descripcion: 'Organización civil presenta denuncia formal por malversación de fondos',
    fecha: new Date('2016-02-15'),
    tipo: 'denuncia',
    created_at: new Date(),
  },
  {
    id: '3',
    caso_id: '1',
    titulo: 'Medidas cautelares contra funcionarios',
    descripcion: 'Juez ordena suspensión de funciones a tres implicados',
    fecha: new Date('2016-08-20'),
  ...
  },
  {
    ...
    descripcion: 'Primer funcionario sentenciado a 12 años de prisión por su participación en la red',
  ...
  },
  {
    id: '5',
    caso_id: '1',
    titulo: 'Resolución de resarcimiento',
    descripcion: 'Tribunal ordena resarcimiento de L. 35 millones al Estado',
    fecha: new Date('2018-03-10'),
    tipo: 'resolucion',
    created_at: new Date(),
  },
  {
    id: '6',
    caso_id: '2',
    titulo: 'Publicación de investigación periodística',
    descripcion: 'Medio de comunicación revela que hospitales nunca entraron en funcionamiento',
    fecha: new Date('2018-03-15'),
    tipo: 'denuncia',
    created_at: new Date(),
  },
  {
    id: '7',
    caso_id: '2',
    titulo: 'Auditoría de la Cuenta Pública',
    descripcion: 'Tribunal Superior de Cuentas detecta irregularidades por L. 35 millones',
    fecha: new Date('2019-06-01'),
    tipo: 'investigacion',
    created_at: new Date(),
  },
  {
    id: '8',
    caso_id: '2',
    titulo: 'Comparecencia de ex ministro',
    descripcion: 'Ex ministro de Salud rinde declaración ante la MACC',
    fecha: new Date('2020-01-20'),
    tipo: 'comparecencia',
    created_at: new Date(),
  },
  {
    id: '9',
    caso_id: '2',
    titulo: 'Medida cautelar: embargo de bienes',
    descripcion: 'Se embargan propiedades de empresas vinculadas al caso',
  ...
  },
  {
    id: '10',
    caso_id: '2',
    titulo: 'Investigación en curso',
    descripcion: 'Fiscalía amplía investigación a nuevos implicados',
    fecha: new Date('2021-09-01'),
    tipo: 'investigacion',
    created_at: new Date(),
  },
];
